...
Auth is the CLI's browser LOGIN (subscription), never an API key. ANTHROPIC_API_KEY
and friends are STRIPPED from the subprocess env — if present, the CLI silently
switches to API-key billing.
"""
...
class ClaudeCliProvider:
    ...
    def _run(self, cmd: str, timeout=None) -> str:
